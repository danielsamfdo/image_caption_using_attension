...
if __name__ == "__main__":
    im = cv2.resize(cv2.imread('imclass_data/train/cats/cat.0.jpg'), (224, 224)).astype(np.float32)
    im[:,:,0] -= 103.939
    im[:,:,1] -= 116.779
    im[:,:,2] -= 123.68
    ...
    im = cv2.resize(cv2.imread('imclass_data/train/dogs/dog.0.jpg'), (224, 224)).astype(np.float32)
    im[:,:,0] -= 103.939
    im[:,:,1] -= 116.779
    im[:,:,2] -= 123.68
    im = im.transpose((2,0,1))
